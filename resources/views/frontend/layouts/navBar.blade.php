...
<form class="example" action="#">
 ...
 {{--  <div class="search-container">
      ...
      <div>
         <select class="selectpicker" data-width="fit" style="margin:25px!important;color:#DAA520; background-color:rgb(59, 57, 57)!important;">
     ...
     <div class="container d-flex justify-content-center justify-content-md-between">
      ...
      <div class="social-links d-none d-md-block" style="margin-top:5px; float:right;">
        <a href="https://www.facebook.com/IESCOMALAYSIA" class="facebook"><i class="bi bi-facebook" style="color:#DAA520;"></i></a>
        <a href="https://www.instagram.com/iescomalaysia/" class="instagram"><i class="bi bi-instagram" style="color:#DAA520;"></i></a>
        <a href="https://twitter.com/IESCOmy" class="twitter"><i class="bi bi-twitter" style="color:#DAA520;;"></i></a>
        <a href="https://www.youtube.com/channel/UCsRHAz9NELlYdfasgq1J4BA" class="youtube"><i class="bi bi-youtube" style="color:#DAA520;;"></i></a>
      </div>
    </div>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
        ...
        <li class="dropdown"><a href="#"><span>Activities</span> <i class="bi bi-chevron-down"></i></a>
          <ul>
              <li><a href="{{route('frontend.implemented')}}">Implemented projects</a></li>
              <li><a href="{{route('frontend.news')}}">organization News</a></li>
            </ul>
          </li>
...
<li class="dropdown"><a href="#"><span>Campaigns</span> <i class="bi bi-chevron-right"></i></a>
          ...
          <li><a class="nav-link scrollto" href="{{route('frontend.scholarship1')}}">Apply for Scholarships</a></li>
          ...
          <li><button class="nav-link scrollto" href="{{ route('login') }}" style="background:#DAA520; color:#515355!important; border-radius:5px; border-color:#515355!important; box-shadow:#515355!important; width:120px!important; height:40px!important;padding:2px!important;font-size:16px!important;"><b>Donate Now<b></button></li>
        </ul>
   ...
   <a href="{{ route('login') }}" class="hi" style="position:-webkit-sticky; position:fixed; top: 50%; right: 0px; transform: translate(-50%, -50%);-ms-transform: translate(-50%, -50%); background:#890000; color:#fff; border-radius:5px; width:120px;height:35px;text-align:center; padding:5px;; margin-right:-55px; ">Fast Donate</a>
