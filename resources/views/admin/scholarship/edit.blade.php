    ...
    <section id="hi" class="hi">
        <div class="container" data-aos="fade-up">
            ...
            <div class="card-body" style="border: 1px solid grey; width:1050px!important;">
                <form action="{{ action('Admin\ScholarshipController@update', [$scholarship->id]) }}" method="POST"
                    ...
                    <div class="form-row col-sm-12" style="font-size:16px;">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" id="first_name" name="first_name" class="form-control"
                                value="{{ $scholarship->first_name }}" required>
                        </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" id="second_name" name="second_name" class="form-control"
                                value="{{ $scholarship->second_name }}" required>
                        </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" id="last_name" name="last_name" class="form-control"
                                value="{{ $scholarship->last_name }}" required>
                        </div>
                        ...
                        <div class="form-group col-sm-4 {{ $errors->has('gender') ? 'has-error' : '' }}">
                            ...
                            <select id="gender" name="gender"
                                ...
                                <option selected value="{{ $scholarship->gender }}">{{ $scholarship->gender }}</option>
                        ...
                        <div class="form-group col-sm-4 {{ $errors->has('nation') ? 'has-error' : '' }}">
                            ...
                            <select id="nation" name="nation"
                                ...
                                <option selected value="{{ $scholarship->nationality }}">
                                    {{ $scholarship->nationality }}</option>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="date" id="birth" name="birth" class="form-control"
                                value="{{ $scholarship->birthday }}" required>
                        </div>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" id="passport" name="passport" class="form-control"
                                value="{{ $scholarship->passport_no }}" required>
                        </div>
                        ...
                        <div class="form-group col-sm-6">
                            ...
                            <input type="email" id="email" name="email" class="form-control"
                                value="{{ $scholarship->email }}" required>
                        </div> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" id="phone" name="phone" class="form-control"
                                value="{{ $scholarship->phone_no }}" required>
                        </div>
                    ...
                    <div class="form-row col-sm-12" style="font-size:16px;">
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" id="uni_name" name="uni_name" class="form-control"
                                value="{{ $scholarship->uni_name }}" required>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" id="major" name="major" class="form-control"
                                value="{{ $scholarship->major }}" required>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" id="matric" name="matric" class="form-control"
                                value="{{ $scholarship->matric_no }}" required>
                        ...
                        <div class="form-group col-sm-4">
                            ...
                            <input type="text" id="cgpa" name="cgpa" class="form-control"
                                value="{{ $scholarship->cgpa }}" required>
