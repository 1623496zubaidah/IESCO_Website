...
<section id="portfolio" class="portfolio" style="margin-top: 4rem; height: inherit;background-color:#E0E0E0!important;">
    ...
    <div class="form-row col-sm-12" style="font-size:16px;">
        ...
        <div class="form-group col-sm-6 {{-- {{ $errors->has('title') ? 'has-error' : '' }}; --}}" style="color:grey;">
            ...
            <input type="text" id="title" name="title" class="form-control" {{-- {{ $errors->has('name') ? 'border-danger' : '' }}" --}} value="{{ old('title', isset($news) ? $news->title : '') }}" required>
          {{--   @if($errors->has('name'))
    ...
    <div class="form-row col-sm-12" style="font-size:16px">
        ...
        <div class="form-group col-sm-12{{ $errors->has('desc') ? 'has-error' : '' }}" style="color:grey;">
            ...
            <textarea id="desc" name="desc" class="form-control {{ $errors->has('desc') ? 'border-danger' : '' }}"  required rows="16">{{ old('desc', isset($news) ? $news->desc : '') }}</textarea>
            @if($errors->has('desc'))
                <em class="invalid-feedback">
                    {{ $errors->first('desc') }}
                </em>
