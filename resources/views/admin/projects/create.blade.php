...
<!-- targeted -->
 <div class="form-group col-sm-12 {{-- {{ $errors->has('title') ? 'has-error' : '' }}; --}}" style="color:#A52A2A!important;">
        ...
        <!-- Type -->
        <div class="form-group col-sm-6 {{ $errors->has('type') ? 'has-error' : '' }}" style="color:#A52A2A!important;">
    ...
    <div class="form-row col-sm-12" style="font-size:16px">
        ...
        <!-- desc -->
        <div class="form-group col-sm-12{{ $errors->has('desc') ? 'has-error' : '' }}" style="color:#A52A2A!important;">
            <label for="desc">{{ trans('cruds.project.fields.desc') }}*</label>
            <textarea id="desc" name="desc" class="form-control {{ $errors->has('desc') ? 'border-danger' : '' }}"  required rows="8">{{ old('desc', isset($project) ? $project->desc : '') }}</textarea>
            @if($errors->has('desc'))
                <em class="invalid-feedback">
                    {{ $errors->first('desc') }}
                </em>
