                ...
                <tbody>
                    @foreach( $projects as $key => $project)
                        <tr data-entry-id="{{ $project->id }}" class="text-capitalize">
                            ...
                            <td>{{ $project->type ?? '' }}</td>
 <td> <img src="{{asset('storage/photos/' . $project->photo)}}" style="width:80px!important; height:50px!important;"></td>
                            ...
                            <td class="text-capitalize">
                              <div class="portfolio-info">
                                    ...
                                    <a class="btn btn-xs btn-primary"  style="background-color:#A0A0A0!important; border-color:#A0A0A0; color:white!important;"  href=" {{('/admin/projects/'). $project->id}} ">
                                    ...
                                    <a class="btn btn-xs btn-warning text-white" style="background-color:#808080!important; border-color:#808080; color:white!important;" href="{{'/admin/projects/' . $project->id . '/edit'}}">
                                    {{ trans('global.edit') }} 
                                    </a>
                                    ...
                                    <form action="{{route('admin.projects.destroy', $project->id) }}" 
                                        method="POST" 
                                        onsubmit="return confirm('{{ $project->projects_count || $project->project ? '' : trans('global.areYouSure') }}');" style="display: inline-block;"
                                    >
