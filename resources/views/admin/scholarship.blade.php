                        ...
                        <tr data-entry-id="{{ $scholarship->id }}" class="text-capitalize">
                            ...
                            <td class="text-capitalize">
                              <div class="portfolio-info">
                                    ...
                                    <a class="btn btn-xs btn-primary"  style="background-color:#A0A0A0!important; border-color:#A0A0A0; color:white!important;"  href="{{('/admin/projects/'). $scholarship->id . '/show'}} ">
                                    ...
                                    <a class="btn btn-xs btn-warning text-white" style="background-color:#808080!important; border-color:#808080; color:white!important;" href="{{'/admin/projects/' . $scholarship->id . '/edit'}}">
                                    {{ trans('global.edit') }} 
                                    </a>
                                    ...
                                    <form action="{{route('admin.projects.destroy', $scholarship->id) }}" 
                                        method="POST" 
                                        onsubmit="return confirm('{{ $scholarship->$scholarships_count || $scholarship->$scholarship ? '' : trans('global.areYouSure') }}');" style="display: inline-block;"
                                    >
