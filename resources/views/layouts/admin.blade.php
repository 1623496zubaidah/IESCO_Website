...
<header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar">
       ...
       <img src="{{ asset("assets/img/logo2.png")}}" alt="" width="160" height="55" background-color="white"> 
       </div>
        <ul>
        <li class="nav-link scrollto"><a href="{{route ('admin.dashboard')}}"><span>Dashboard</span> <i class="#"></i></a>
          </li>

           <li class="nav-link scrollto"><a href="{{route ('admin.scholarship')}}"><span>Scholarship</span> <i class="#"></i></a>
          </li>
